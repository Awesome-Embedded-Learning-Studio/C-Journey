---
title: "函数基础与参数传递"
description: "理解 C 函数的声明定义调用机制、值传递本质、指针参数、返回值策略和递归原理，把模块化编程的基本单元吃透。"
chapter: 1
order: 5
tags:
  - host
...
c_standard: [99, 11]
prerequisites:
  - "Chapter 1：基本语法（变量、类型、运算符）"
  - "Chapter 2：指针与数组、const 和空指针"
---
...
听起来很简单，但函数背后的机制——参数是怎么传进去的、返回值是怎么回来的、栈帧是怎么运作的——理解到位了，后面写工程级代码、做系统编程、调试段错误的时候才不会感到困惑。
