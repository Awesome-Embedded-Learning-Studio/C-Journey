...
- clang-format 文档与 `clang-format --dump-config`（所有配置项；本项目 [.clang-format](https://github.com/Charliechen114514/C-Journey/blob/main/.clang-format)）
...
- 本项目 [AGENTS.md](https://github.com/Charliechen114514/C-Journey/blob/main/AGENTS.md)（代码风格与 C 铁律）、`.claude/writing-style.md`（文档写作规范，文档侧的「质量门」）
